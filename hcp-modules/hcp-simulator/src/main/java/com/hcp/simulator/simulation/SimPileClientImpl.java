...
public class SimPileClientImpl implements SimPileIClient {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    // 峰时段 08:00-12:00
                    rateDetailList.add(new RateDetailDTO(1L,
                            new BigDecimal("1.2"), new BigDecimal("0.6"), "08:00:00", "12:00:00"));
                    // 平时段 12:00-18:00
                    rateDetailList.add(new RateDetailDTO(2L,
                            new BigDecimal("0.8"), new BigDecimal("0.4"), "12:00:00", "18:00:00"));
                    // 谷时段 18:00-24:00
                    rateDetailList.add(new RateDetailDTO(3L,
     ...
     * 模拟费率模板数据
     */
    private List<RateDetailDTO> buildMockRateDetails() {
        List<RateDetailDTO> list = new ArrayList<>();
        // 模拟2段费率（尖峰时段）
        RateDetailDTO dto1 = new RateDetailDTO(1L, BigDecimal.valueOf(1.2), BigDecimal.valueOf(0.5), "08:00:00", "12:00:00");
        RateDetailDTO dto2 = new RateDetailDTO(2L, BigDecimal.valueOf(0.8), BigDecimal.valueOf(0.3), "12:00:00", "24:00:00");
        list.add(dto1);
        list.add(dto2);
        return list;
    }
